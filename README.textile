...
A library for extracting data out of "Scout Monitoring (scoutapp.com)":http//scoutapp.com, a hosted monitoring service. This is experimental and likely to change. 
...
The library allows you to extract aggregate metrics across all and/or selected servers in your account. @See Metric#average@
